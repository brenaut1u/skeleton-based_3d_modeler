...
public:
    ...
    void render(const hittable_list& world, const std::vector<light>& lights, span3D image);

    void render(const hittable_list& world, const std::vector<light>& lights, span3D image, const vector<screen_segment>& skeleton);
